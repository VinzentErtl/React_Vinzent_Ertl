...
export default function Position2({ index, team }) {
  ...
  return (
    <div className="w-[26rem] border-solid border-[0.1rem] border-black p-2 my-2 flex flex-row content-between items-center hover:bg-white bg-[#D3D3D3] grid grid-cols-[40px_40px_auto_40px]">
